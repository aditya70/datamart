...
<body>
    ...
    <section>
            ...
            <div class="shz-card-white shz-center-page" style=" min-height:100px !important; height:150px;">
                <h3 class=" shz-title shz-margin-bottom-10">Select a datatype</h3>
                
                <form action="./template_option_action.php" method="post" enctype="multipart/form-data">
